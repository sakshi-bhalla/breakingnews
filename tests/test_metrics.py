...
The values pinned in `TestPublishedTable` are the V4_hard test-split numbers
...
class TestPublishedTable:
    """V4_hard, test split: 20 transcripts, 64 gold breaks, 86 predicted.

    Reproduced exactly from `pred_V4_hard_tau0.01_test.jsonl`. Kept as
